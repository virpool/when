	...
	function makePromise(environment) {
		...
		Promise.prototype.then = function(onFulfilled, onRejected, onProgress) {
			...
			this._handler.when(function(x) {
				...
				p._handler.notify(x);
			}, this._handler.receiver, onFulfilled, onRejected, onProgress);

			return p;
		};

		Promise.prototype['with'] = Promise.prototype.withThis = function(receiver) {
			return new InternalPromise(new FollowingHandler(this, receiver));
		};
		...
		Promise.prototype.done = function(handleResult, handleError) {
			var p = this;
			this._handler.when(function(x) {
				getHandler(void 0, x).when(noop, noop, p._handler.receiver,
					void 0, p._fatal);
			}, noop, p._handler.receiver, handleResult, handleError);
		};
		...
		FollowingHandler.prototype.when = function(resolve, notify, receiver, f, r, u) {
			...
			this.promise._handler.when(resolve, notify,
				this.receiver === void 0 ? receiver : this.receiver, f, r, u);
		};
